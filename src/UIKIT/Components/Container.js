...
function Container({ style, children, containerProps, statusBarStyle, statusBarBackgroundColor, fullScreen, }) {
    ...
    return useMemo(() => (<Fragment>
        <StatusBar barStyle={statusBarStyle || Theme.statusbar.style} backgroundColor={statusBarBackgroundColor || Theme.statusbar.backgroundColor} translucent={fullScreen || false}/>
